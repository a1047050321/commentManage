...
(function($, window, undefined) {
    ...
    var methods = {
        ...
        getContent: function(layerID) {
            ...
            if (!tlayer || !tlayer.layerData.layers[layerID]) {
                return false; }
    ...
    var layerUtil = {
        ...
        content: function(layerID) {
            ...
            if (c.src) {
                ...
                contentHTML += '<iframe class="layer-box-content layer-box-iframe" src="' + c.src + '"></iframe>';
        ...
        showLayer: function(layerID, fn) {
            ...
            if (util.inArray(layerID, layerData.stack) > -1) {
                return false; }
